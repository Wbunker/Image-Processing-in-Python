...
class BGRPortraCurveFilter(BGRCurveFilter):
    """A filter that applies Portra-like curves to the BGR channels."""
...
class BGRProviaCurveFilter(BGRCurveFilter):
    """A filter that applies Provia-like curves to the BGR channels."""
    def __init__(self, dtype = np.uint8):
        BGRCurveFilter.__init__(self,
...
class BGRVelviaCurveFilter(BGRCurveFilter):
    """A filter that applies Velvia-like curves to the BGR channels."""
    def __init__(self, dtype = np.uint8):
        BGRCurveFilter.__init__(self,
...
class BGRCrossProcessCurveFilter(BGRCurveFilter):
    """A filter that applies cross-process like curves to the BGR channels."""
    def __init__(self, dtype = np.uint8):
        BGRCurveFilter.__init__(self,
